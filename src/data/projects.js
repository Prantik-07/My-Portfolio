export const projects = [
  ...
  {
    name: "openenv-accessibility-auditor",
    title: "OpenEnv Accessibility Auditor",
    description:
      "An accessibility auditing environment built for automated, repeatable a11y testing.",
    url: "https://github.com/Prantik-07/openenv-accessibility-auditor",
    homepage: null,
    language: "Python",
    topics: [],
    featured: false,
  ...
  },
  {
    name: "bountyboard",
    title: "Bounty Board",
    description: "A TypeScript application for posting and tracking bounties.",
    url: "https://github.com/Prantik-07/bountyboard",
    homepage: null,
    language: "TypeScript",
    topics: [],
    featured: false,
