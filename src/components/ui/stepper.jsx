...
export default function Stepper({
  ...
  return (
    <div className="stepper-outer" {...rest}>
      <div
        className={`stepper-card border ${stepCircleContainerClassName}`}
        ...
        {!isCompleted && (
          <div className={`stepper-footer ${footerClassName}`}>
            <div className={`stepper-footer-nav ${currentStep !== 1 ? "spread" : "end"}`}>
              ...
              <button onClick={isLastStep ? handleComplete : handleNext} className="stepper-next-btn" {...nextButtonProps}>
...
function StepIndicator({ step, currentStep, onClickStep, disableStepIndicators }) {
  ...
  return (
    ...
    >
      <motion.div
        variants={{
          inactive: { scale: 1, backgroundColor: PALETTE.inactiveBg, color: PALETTE.inactiveText },
          active: { scale: 1.08, backgroundColor: PALETTE.activeBg, color: PALETTE.activeBg },
          complete: { scale: 1, backgroundColor: PALETTE.completeBg, color: PALETTE.completeBg },
        }}
...
function StepConnector({ isComplete }) {
  const lineVariants = {
    ...
    complete: { width: "100%", backgroundColor: PALETTE.completeBg },
  };
